import { DocumentColorParams, DocumentFormattingParams, DocumentLinkParams, IConnection, TextDocumentPositionParams, ColorPresentationParams, InitializeParams, ServerCapabilities } from 'vscode-languageserver';
